...
public class metoder {
	...
	/**
	 * Skriver två heltal och skickar vidare dem till metoden ifInteger.
	 */
	...
	/**
	 * Jämför två olika heltal och bestämmer vilket som är störst och vilket som är
	 * minst. Samt skickar tillbaka en hälsning.
	 * 
	 * @param integer1
	 * @param integer2
	 * @return
